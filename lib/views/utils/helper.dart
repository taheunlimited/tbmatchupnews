...
//* Color
Color cPrimary = const Color(0xff7289da);
Color cTextBlue = const Color(0xff4a598d);
Color cDarkDc = const Color(0xff465381);
Color cBgDc = const Color(0xff282b30);
Color cBoxDc = const Color(0xff1e2124);
...
//* TextStyle
TextStyle headline1 = GoogleFonts.montserrat(fontSize: 40);
TextStyle headline2 = GoogleFonts.montserrat(fontSize: 34);
TextStyle headline3 = GoogleFonts.montserrat(fontSize: 24);
TextStyle headline4 = GoogleFonts.montserrat(fontSize: 20);
TextStyle subtitle1 = GoogleFonts.montserrat(fontSize: 16);
TextStyle subtitle2 = GoogleFonts.montserrat(fontSize: 14);
TextStyle caption = GoogleFonts.montserrat(fontSize: 12);
TextStyle overline = GoogleFonts.montserrat(fontSize: 10);
